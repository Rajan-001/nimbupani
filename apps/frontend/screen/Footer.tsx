  ...
  return (
       ...
       <div className='grid grid-cols-2  pt-24 w-full h-104 px-12'>
          <div className='w-full h-full flex px-12 leading-12 justify-center  text-center text-3xl items-center'>
            <div className='inline font-semibold text-blue-950'>
    ...
    <motion.div style={{x:offsetfooter}} className='text-[100px] whitespace-nowrap font-extrabold  text-blue-950 text-center uppercase absolute  h-60 w-[140vw]  bottom-8 flex justify-center items-center'>
